...
namespace BookShop.Controllers
{
    public class CartsController : Controller
    {
        ...
        public CartsController(myShopContext context)
        {
            _context = context;
        }
        ...
        {
            var myShopContext = _context.Carts.Include(c => c.Product).Include(c => c.User);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'myShopContext.Carts'  is null.");
            }
            var cart = await _context.Carts.FindAsync(id);
            if (cart != null)
            {
